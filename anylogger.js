 ...
 * @param c {Object} An optional config object
 *
 ...
 *
 * @param n {String} The name of the logger to use
 * @param x {Array} The log arguments
 *
 ...
 *
 * @param l Function The logger to be (re-)extended
 * @param o
